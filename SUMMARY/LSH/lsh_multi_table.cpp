 ...
 *
 * @param numTables : Number of LSH tables
 * @param nPoints1 : Number of base points and size of groupArray
 ...
 *
 * @param points1 : Array of points used to create the LSH tables. (base points)
 *
 * @param points2 : Array of points to be matched with points1. (query points)
 *
 ...
 *                           indices of all possible matches for each query point
 *                           in points2.
 ...
 *
 * @param potentialMatchesLengths : Number of matches for each point in points2.
 *                                  Used to iterate through potentialMatches.
 *
 ...
 *                         Distances between points for every match in lshMatches.
 *
